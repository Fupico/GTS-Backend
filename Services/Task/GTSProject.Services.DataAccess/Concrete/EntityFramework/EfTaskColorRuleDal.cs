...
{
    public class EfTaskColorRuleDal : EfEntityRepositoryBase<TaskColorRule, TaskServiceContext>, ITaskColorRuleDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfTaskColorRuleDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
