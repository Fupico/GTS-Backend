...
{
    public class EfTaskHistoryDal : EfEntityRepositoryBase<TaskHistory, TaskServiceContext>, ITaskHistoryDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfTaskHistoryDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
