...
{
    public class EfTaskRelationTypeDal : EfEntityRepositoryBase<TaskRelationType, TaskServiceContext>, ITaskRelationTypeDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfTaskRelationTypeDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
