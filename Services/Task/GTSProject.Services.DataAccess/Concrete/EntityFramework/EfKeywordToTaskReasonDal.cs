...
{
    public class EfKeywordToTaskReasonDal : EfEntityRepositoryBase<KeywordToTaskReason, TaskServiceContext>, IKeywordToTaskReasonDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfKeywordToTaskReasonDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
