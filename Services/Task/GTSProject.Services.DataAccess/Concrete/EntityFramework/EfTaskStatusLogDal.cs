...
{
    public class EfTaskStatusLogDal : EfEntityRepositoryBase<TaskStatusLog, TaskServiceContext>, ITaskStatusLogDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfTaskStatusLogDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
