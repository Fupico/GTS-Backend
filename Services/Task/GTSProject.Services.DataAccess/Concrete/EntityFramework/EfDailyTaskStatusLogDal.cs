...
{
    public class EfDailyTaskStatusLogDal : EfEntityRepositoryBase<DailyTaskStatusLog, TaskServiceContext>, IDailyTaskStatusLogDal
    {
        private readonly TaskServiceContext _context;
        private readonly IUnitOfWork<TaskServiceContext> _unitOfWork;

        public EfDailyTaskStatusLogDal(TaskServiceContext context, IUnitOfWork<TaskServiceContext> unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
