...
namespace UserManagementSystem.Services.Implementations
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(CustomUserManager userManager, IOptions<CustomTokenOption> options)
        {
        ...
        private IEnumerable<Claim> GetClaims(FupiUser userApp, List<String> audiences)
        {
        ...
        public TokenDto CreateToken(FupiUser userApp)
        {
        ...
        public ClientTokenDto CreateTokenByClient(ClientDto client)
        {
            var accessTokenExpiration = DateTime.Now.AddMinutes(_tokenOption.AccessTokenExpiration);
